...
select throws_ok(
  $$ insert into public.match_messages (match_id, sender_id, body) values ('44444444-4444-4444-4444-444444444444','33333333-3333-3333-3333-333333333333','Ciao a tutti') $$,
  null,
...
values ('77777777-7777-7777-7777-777777777777','44444444-4444-4444-4444-444444444444','22222222-2222-2222-2222-222222222222','Ciao a tutti');

select is(
  (select count(*)::int from public.match_messages where match_id = '44444444-4444-4444-4444-444444444444'),
  1,
...
select is(
  (select type from public.notifications where user_id = '11111111-1111-1111-1111-111111111111' order by created_at desc limit 1),
  'match_message',
  'other approved participants are notified of a new room message'
);
